      ...
      <div class="card">
        <div class="card-body">
          ...
          <h4 class="lead my-4">Вот примеры связок, которые будет сложно найти быстро без нашего поисковика:</h4>
            ...
            <h4 class="lead my-2 mb-3">Вопросы, предложения, замечания и найденные ошибки приветствуются.</h4>
            <p>Можно написать в комментариях на <a href="https://xn----8sba0bbi0cdm.xn--p1ai/qa/question/view-2226" target="_blank">ФКТ</a>, на <a href="https://github.com/terratensor" target="_blank">гитхабе</a> или воспользоваться страницей <a href="https://svodd.ru/contact" target="_blank">обратной связи</a>.</p>
            <h4 class="lead">Удачного поиска, друзья!</h4>
